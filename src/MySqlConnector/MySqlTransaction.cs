...
public sealed class MySqlTransaction : DbTransaction
{
	...
	private async Task CommitAsync(IOBehavior ioBehavior, CancellationToken cancellationToken)
	{
		...
		using var activity = Connection!.Session.StartActivity("Commit", operationName: "COMMIT");
...
#pragma warning restore CA2012
	...
	{
		using var activity = Connection!.Session.StartActivity("Rollback", operationName: "ROLLBACK");
