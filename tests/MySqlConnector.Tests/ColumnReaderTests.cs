...
public class ColumnReaderTests
{
	...
	[InlineData("2000/01-01")]
	[InlineData("2000-1-01")]
	[InlineData("2000-001-01")]
	[InlineData("2000-aa-01")]
	[InlineData("2000-01")]
	[InlineData("2000-01/01")]
	[InlineData("2000-01-1")]
	[InlineData("2000-01-001")]
	[InlineData("2000-01-aa")]
	...
	[InlineData("0001-00-00")]
	[InlineData("10000-01-01")]
	[InlineData("2000-01-01 ")]
	[InlineData("2000-01-01T01:01:01")]
	[InlineData("2000-01-01 01")]
	[InlineData("2000-01-01 01:01")]
	[InlineData("2000-01-01 1:01:01")]
	[InlineData("2000-01-01 aa:01:01")]
	[InlineData("2000-01-01 24:00:00")]
	[InlineData("2000-01-01 01-01-01")]
	[InlineData("2000-01-01 01:1:01")]
	[InlineData("2000-01-01 01:aa:01")]
	[InlineData("2000-01-01 01:60:01")]
	[InlineData("2000-01-01 01:01-01")]
	[InlineData("2000-01-01 01:01:1")]
	[InlineData("2000-01-01 01:01:aa")]
	...
	[InlineData("-999-12-31 12:34:56")]
	[InlineData("2345--1-31 12:34:56")]
	[InlineData("2345-12--1 12:34:56")]
	[InlineData("2345-12-31 -1:34:56")]
	[InlineData("2345-12-31 12:-1:56")]
	[InlineData("2345-12-31 12:34:-1")]
	public void RejectInvalidDateTime(string input)
	{
